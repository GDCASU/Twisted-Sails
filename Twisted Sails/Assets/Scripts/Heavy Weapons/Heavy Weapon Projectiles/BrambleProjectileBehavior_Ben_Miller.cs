...
public class BrambleProjectileBehavior_Ben_Miller : InteractiveObject
{
	...
	void OnTriggerEnter (Collider other) {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            OnInteractWithPlayer(other.GetComponent<GameObject>(), other.GetComponent<StatusEffectsManager>(), other.GetComponent<Collision>(), other.GetComponent<Health>());
        }
    ...
    public override void OnInteractWithPlayer(GameObject playerBoat, StatusEffectsManager manager, Collision collision, Health playerHealth)
    {
        ...
        playerHealth.CmdHurtSelf(damageDealt);
